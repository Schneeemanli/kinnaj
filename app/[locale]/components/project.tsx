      ...
      <div className="px-4 sm:px-8 md:px-14 lg:px-18 pt-10 pb-8 flex items-center justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <RevealOnScroll time="2">
            <div className="bg-white shadow-lg rounded-sm overflow-hidden animate-client-card-three">
              <div className="flex items-center justify-center p-8">
                <img
                  src="/client_logos/bastella.png"
                  alt="Client 2 Logo"
                  className="w-32 h-32 object-contain"
                />
              </div>
          ...
          <RevealOnScroll time="3">
            <div className="bg-white shadow-lg rounded-sm overflow-hidden animate-client-card-four">
              <div className="flex items-center justify-center p-8">
                <img
                  src="/client_logos/Castiglione_Falletto.png"
                  alt="Client 2 Logo"
                  className="w-32 h-32 object-contain"
                />
              </div>
